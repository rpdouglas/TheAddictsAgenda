    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-lg animate-fade-in h-full flex flex-col overflow-y-auto">
            ...
            <div className="space-y-12">
                ...
                {/* --- JOURNAL SECTION (UPDATED WITH WALKTHROUGHS) --- */}
                ...
                <section ref={sections['literature']} id="literature" className="border-b pb-8">
                    ...
                    <p className="mb-4">Read the Big Book, Basic Text, and other recovery literature directly in the app.</p>
                    <ul className="list-disc pl-5 space-y-2 text-gray-700">
                        <li><strong>Search:</strong> Use the search bar to find specific passages or keywords across the texts.</li>
                        <li><strong>Chapter Selection:</strong> Browse by chapter to easily find the reading for your meeting.</li>
                    </ul>
                </section>
