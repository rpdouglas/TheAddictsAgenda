...
export const LifestyleBalanceTool = () => {
    ...
    const explanation = "Recovery isn't just about stopping a behavior; it's about building a life you don't need to escape from. This tool provides a visual snapshot of your satisfaction across key life areas, helping you identify neglect.";
    
    const walkthrough = [
        { title: "Rate Areas", desc: "Use the sliders to rate your current satisfaction (1-10) in the six life areas." },
        { title: "Visualize", desc: "Watch the Radar Chart update. A full circle means balance; a 'dented' shape shows areas needing work." },
        { title: "Analyze", desc: "Identify the lowest scores. These are your risk areas for burnout or relapse." }
    ];
